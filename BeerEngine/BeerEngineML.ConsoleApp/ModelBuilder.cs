...
using BeerEngineML.Model;
using Microsoft.ML.Vision;

namespace BeerEngineML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\Antho\AppData\Local\Temp\12512401-88ab-4244-a2a0-7ea3854da241.tsv";
        private static string MODEL_FILEPATH = @"../../../../BeerEngineML.Model/MLModel.zip";
